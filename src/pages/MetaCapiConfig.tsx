    ...
    <Card className="max-w-2xl border-none shadow-none md:border md:shadow-sm">
      ...
      <CardContent className="space-y-6 px-0 md:px-6">
        ...
        <div className="space-y-2">
          ...
          />
          {fieldErrors.pixelId && <p className="text-xs text-destructive">{fieldErrors.pixelId}</p>}
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            className={fieldErrors.token ? 'border-destructive focus-visible:ring-destructive' : ''}
          />
