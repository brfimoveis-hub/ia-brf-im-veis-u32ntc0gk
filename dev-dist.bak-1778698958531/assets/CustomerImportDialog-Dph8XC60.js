import { D as require_react, T as useToast, k as __toESM, r as Button, u as createLucideIcon, x as require_jsx_runtime } from "./client-CVWO68xh.js";
import { a as DialogHeader, n as DialogContent, o as DialogTitle, r as DialogDescription, t as Dialog } from "./dialog-D1OGDVgL.js";
import { A as LoaderCircle, C as Upload, j as FileText, s as createCustomerWithRetry } from "./index-B-lyNKbh.js";
...
function CustomerImportDialog({ open, onOpenChange, onSuccess }) {
	...
	const handleFileUpload = async (e) => {
		...
		try {
			...
			if (isCsv) {
				...
				if (lines.length > 0) {
					...
					for (let i = 1; i < lines.length; i++) {
						...
						if (contact.name || contact.email || contact.phone || contact.first_name || contact.telefone) parsedContacts.push({
				...
				for (const card of vcards) {
					...
					if (name || phone || email) parsedContacts.push({
						name: name || "Sem nome",
						phone,
						email,
						status: "Base de Clientes/Novo LYD",
			...
			if (parsedContacts.length === 0) throw new Error("Nenhum contato válido encontrado no arquivo.");
			let successCount = 0;
				...
				children: isUploading ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							"data-prohibitions": "[]",
							className: "flex flex-col items-center gap-2 text-muted-foreground",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileBadge, {
