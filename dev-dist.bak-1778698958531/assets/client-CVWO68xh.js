...
var formatPhone = (phone) => {
	...
	if (digits.length >= 10 && digits.length <= 11) return digits.replace(/^(\d{2})(\d{4,5})(\d{4})$/, "($1) $2-$3");
	return phone.trim();
};
//#endregion
...
//#endregion
export { useComposedRefs as C, require_react as D, require_react_dom as E, __commonJSMin as O, composeRefs as S, useToast as T, createSlot$1 as _, Slot as a, createContextScope as b, formatPhone as c, cva as d, Presence as f, dispatchDiscreteCustomEvent as g, Primitive as h, buttonVariants as i, __toESM as k, X as l, useCallbackRef as m, ClientResponseError as n, createSlot as o, useLayoutEffect2 as p, Button as r, cn as s, pb as t, createLucideIcon as u, createSlottable as v, composeEventHandlers as w, require_jsx_runtime as x, createContext2 as y };
