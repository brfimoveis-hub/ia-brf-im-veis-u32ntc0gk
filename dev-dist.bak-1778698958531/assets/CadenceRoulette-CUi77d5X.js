import { D as require_react, T as useToast, k as __toESM, l as X, r as Button, s as cn, u as createLucideIcon, x as require_jsx_runtime } from "./client-CVWO68xh.js";
import { t as ScrollArea, u as useBlocker } from "./scroll-area-qQDYGHrB.js";
import { A as LoaderCircle, D as Phone, E as Play, M as ChevronRight, O as Pen, S as User, T as RefreshCw, c as getPaginatedCustomers, d as CardContent, f as CardDescription, g as Badge, k as MessageSquare, l as updateCustomer, m as CardTitle, n as updateCadence, p as CardHeader, r as Textarea, t as getActiveCadences, u as Card, w as Save } from "./index-B-lyNKbh.js";
...
function CadenceRoulette({ search = "", phaseFilter = "all", sourceFilter = "", onCustomerUpdated } = {}) {
	...
	const blocker = useBlocker(({ currentLocation, nextLocation }) => (isEditingCadence || isEditingNotes) && currentLocation.pathname !== nextLocation.pathname);
	(0, import_react.useEffect)(() => {
		if (blocker.state === "blocked") toast({
	...
	const loadLeads = (0, import_react.useCallback)(async (p, overwrite = false) => {
		try {
	...
	(0, import_react.useEffect)(() => {
		if (leads.length > 0 && globalIndex >= leads.length - 5 && hasMore && !isFetchingMore) loadMore();
	}, [
		globalIndex,
		leads.length,
		hasMore,
	...
	(0, import_react.useEffect)(() => {
		const timeoutId = setTimeout(() => {
			if (itemRefs.current[globalIndex] && !isPaused && !isEditingCadence && !isEditingNotes) itemRefs.current[globalIndex]?.scrollIntoView({
				behavior: "smooth",
				block: "center"
			});
		}, 150);
	...
	(0, import_react.useEffect)(() => {
		if (!isInitialized || isLoading || isPaused || isEditingCadence || isEditingNotes || totalItems === 0) return;
	...
	if (!isInitialized || isLoading && leads.length === 0) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
	...
	if (!isLoading && leads.length === 0) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
		...
		"data-prohibitions": "[editContent]",
		className: cn("shadow-subtle border-primary/10 bg-gradient-to-br from-background to-primary/5 overflow-hidden relative transition-opacity duration-200 flex flex-col h-[700px]", isLoading && "pointer-events-none"),
		children: [
			isLoading && leads.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: !isLoading && !isPaused && !isEditingCadence && !isEditingNotes && totalItems > 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
						...
						children: [isPaused ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Play, {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [cadences.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							trigger && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Badge, {
							...
							channel && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Badge, {
					...
					}), isEditingCadence ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					}) : currentCadence ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						leads.map((customer, index) => {
							...
							return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								className: cn("bg-background/90 backdrop-blur-sm border rounded-xl p-4 transition-all duration-300 cursor-pointer", isActive ? "border-primary shadow-md ring-1 ring-primary/20 relative" : "border-border/60 shadow-sm hover:border-primary/40 opacity-70 hover:opacity-100"),
								onClick: () => {
								...
								children: [isActive && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
													...
													"data-prohibitions": "[editContent]",
													className: cn("font-semibold", isActive ? "text-primary" : "text-secondary"),
										...
										}), (customer.phone || customer.phone_1_value) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: isEditingThisNotes ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
													...
													children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
														...
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(StickyNote, {
															"data-uid": "src/components/CadenceRoulette.tsx:557:29",
															"data-prohibitions": "[editContent]",
															className: "w-3.5 h-3.5"
														}), " Anotações"]
													})
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													...
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
														...
														className: "h-7 text-xs",
														children: [isSaving && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, {
															"data-uid": "src/components/CadenceRoulette.tsx:583:42",
															"data-prohibitions": "[editContent]",
											...
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
													...
													children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
														...
														className: "h-6 w-6",
														children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pen, {
															"data-uid": "src/components/CadenceRoulette.tsx:598:29",
															"data-prohibitions": "[editContent]",
															className: "w-3 h-3"
														})
													})
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
													...
													"data-prohibitions": "[editContent]",
													className: cn("text-sm p-2 rounded border transition-colors", isActive ? "bg-primary/5 border-primary/20 text-secondary" : "bg-muted/30 border-transparent group-hover/notes:border-border/50 text-secondary/80"),
													children: customer.notes ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						isFetchingMore && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						!hasMore && leads.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
