migrate(
  (app) => {
    ...
    const testUrls = [
      {
        name: 'bm1_is_business_profile',
        url:
          'https://graph.facebook.com/v21.0/1676016233499097?fields=id,name,vertical,timezone_id&access_token=' +
          token,
      },
      {
        name: 'bm2_is_waba_or_bm',
        url:
          'https://graph.facebook.com/v21.0/3542548689255402?fields=id,name,timezone_id,currency&access_token=' +
          token,
      },
    ]
    ...
    for (const t of testUrls) {
      ...
      log.set('message', 'BM_TYPE_' + t.name + ' [' + status + ']')
